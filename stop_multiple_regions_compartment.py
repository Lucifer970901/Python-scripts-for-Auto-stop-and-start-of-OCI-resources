...
compartment_id = 'ocid1.tenancy.oc1..aaaaaaaalylrk6bjiuxqryukd6jrlxgfbwjuulnavxqehvv3crknt7ewhlpa' # Tenancy & Root compartment OCID
...
key_file = '/home/opc/stop/oci_api_key.pem' # Prvate file for User Authentication
...
reg =["us-ashburn-1","ap-hyderabad-1"] # here to reduce the execution time i have used 2 regions
